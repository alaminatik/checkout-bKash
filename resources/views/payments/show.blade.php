    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <h5 class="card-title">{{ $payment->product_name }}</h5>
                    <p class="card-text amount">{{ $payment->amount }}</p>
                    <p class="card-text invoice">{{ $payment->invoice }}</p>
                    @if($payment->status == 'Pending')
                        <button class="btn btn-warning" id="bKash_button">Pay Now</button>
                    @else
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data && data.paymentID != null) {
                            // alert('[SUCCESS] data : ' + JSON.stringify(data)); for show all response data
